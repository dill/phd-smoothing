...
It is also interesting to look at the behaviour of a grid placed over the domain. Taking the evenly spaced grid in \fig{wt2-grid-orig}, first MDS is performed on a dense grid of 1253 points, and then a less dense grid is inserted using the method of Gower.
