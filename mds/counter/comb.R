...
par(pch=19,las=1,mgp=c(1.5,0.75,0),mar=c(3,3,2,2),cex.axis=0.5,cex.lab=0.7,mfrow=c(1,3))

# 3d mds plot
grid.mds3<-cmdscale(D,eig=TRUE,k=3,x.ret=TRUE)
plot(grid.mds3$points[,1],grid.mds3$points[,2],xlab="x*",ylab="y*",col=cols,asp=1,cex=0.3)
plot(grid.mds3$points[,1],grid.mds3$points[,3],xlab="x*",ylab="z*",col=cols,asp=1,cex=0.3)
plot(grid.mds3$points[,2],grid.mds3$points[,3],xlab="y*",ylab="z*",col=cols,asp=1,cex=0.3)
...
par(pch=19,las=1,mgp=c(1.9,0.75,0),mar=c(3,3,2,2),cex.axis=0.5,cex.lab=0.7)
grid.mds4<-cmdscale(D,eig=TRUE,k=4,x.ret=TRUE)
plot(grid.mds4$points[,1],grid.mds4$points[,2],xlab="x*",ylab="y*",col=cols,asp=1,cex=0.3)
plot(grid.mds4$points[,2],grid.mds4$points[,3],xlab="y*",ylab="z*",col=cols,asp=1,cex=0.3)
plot(grid.mds4$points[,1],grid.mds4$points[,3],xlab="x*",ylab="z*",col=cols,asp=1,cex=0.3)
plot(grid.mds4$points[,3],grid.mds4$points[,4],xlab="z*",ylab="w*",col=cols,asp=1,cex=0.3)
plot(grid.mds4$points[,1],grid.mds4$points[,4],ylab="w*",xlab="x*",col=cols,asp=1,cex=0.3)
plot(grid.mds4$points[,2],grid.mds4$points[,4],xlab="y*",ylab="w*",col=cols,asp=1,cex=0.3)
