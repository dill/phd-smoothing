...
Parameters are estimated using maximum likelihood. In practise maximization is performed on the $\log$-likelihood (see \secref{s:optimization}) with analytic gradients (given in appendix \ref{app-mixderivs}).
