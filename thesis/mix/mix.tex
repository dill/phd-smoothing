...
\begin{enumerate}
	\item For a set sample size $n$, calculate the size of samples from each part of the mixture, $n_j = n \pi_j$ for $j=1\cdots,J$.
...
\begin{enumerate}
   \item Generate a set of covariate values $z_{ik}$ for $i=1,\cdots,n, k=1,\cdots,K$.
