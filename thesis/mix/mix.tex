...
Following on from the definitions of the detection functions given in \secref{intro-ds-detfct}\label{cor-8s2}, this section shows how from the definition of a mixture model detection function, the likelihood can be found for covariate and non-covariate models of both line and point transect data.
