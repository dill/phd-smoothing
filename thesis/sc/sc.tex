...
Looking at a more realistic domain highlights potential problems with a \sch\ transform approach. The domain in the top left corner of \fig{sc-wigglytop2-real} shows a domain which is supposed to replicate the features of a coastline.
