...
\centering
% trim order l b r t
\includegraphics[width=4in]{sc/figs/wigglytop2-real.pdf} \\
...
\Fig{wigglytop2-boxplots} also shows the results of using the bounding box shown in \fig{wigglytop2-bbox-numbered} with the \sch mapping (again mapping to the rectangle.) This was an attempt to reduce the distortions seen in \fig{sc-wigglytop2-real}. There is no significant increase in performance by attempting to use the bounding box. Although this ironed out some of the weird features in the smooth, \fig{wigglytop2-bbox-real} shows that new features appear. Patently, there is no advantage in using the \sch transform in this situation.
...
\centering
% trim order l b r t
\includegraphics[width=3in]{sc/figs/wigglytop2-bbox-real.pdf} \\
