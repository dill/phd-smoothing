...
\label{tprs-basis}
\end{equation}
where the first summation is a series of radial basis functions ($i$ indexing the $n$ data), one per datum and the second sums the unpenalised terms in the nullspace of the penalty (\cite{wood2003}). These are $M$ linearly independent polynomials of degree less than $m$. $M$ is given by:
\begin{equation*}
