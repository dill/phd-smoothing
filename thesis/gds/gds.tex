...
There is still an issue with speed. Although there are several tweaks still available to make the within-area distance algorithm faster. Finding schemes for the layout of starting grids and perhaps adapting the methods described in \citeb{mdskrig} to approximate the distances using a triangulation, would certainly increase performance (although perhaps at the price of accuracy).
...
Moving on to the more general distance smoothing that was seen in the last part of this chapter...
