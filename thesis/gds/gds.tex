...
\begin{itemize}
   ...
   \item A geostatistical/krigging approach could also be used, that is modelling explicitly the spatial covariance function. Using MDS as a dimension expansion technique with krigging has been explored by [[CITE Gavin paper]] and earlier by [[CITE Curriero]].
