...
Going back to the general GAM objective function given in \secref{GAMobjfcn}, we can examine the penalty term. Recapping the thin plate penalty in $d$ dimensions with penalty order $m$ is given in (\ref{tprs-pen}) as:
\begin{equation}
