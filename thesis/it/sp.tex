...
In order to create a a spatiotemporal smooth, tensor product smoother is used. This is a natural extension of the spatial tensor product given in \secref{GAMtensor}, however in this case the spatial smooth is isotropic (and treated effectively as one component) and the temporal component is  a marginal one-dimensional spline basis. This section gives the general construction of such a three-dimensional smoother.
