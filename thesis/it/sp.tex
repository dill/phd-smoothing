...
The next section shows how $f_\text{space}$ and $J_\text{space}$ can be constructed.   
...
$$
[[TKTKTK say something about the cyclic spline basis]] see e.g. \cite{simonbook} PAGE for more details.
