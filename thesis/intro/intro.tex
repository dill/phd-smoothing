...
\begin{equation}
\sum_{i=1}^n (\bm{z} - f(x_i))^2 +  \lambda \sum_{j=1}^{J+m+1} \Delta^2 \beta_j,
\end{equation}
...
So far only unidimensional P-splines have been considered. It is possible to build 2-dimensional (and higher) smooths from \textit{tensor products} of 1-dimensional smooths.
