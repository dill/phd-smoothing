...
If this were to happen it would imply that both $\mathcal{P_2}^*$ was shorter than $\mathcal{P_1}^*$ and $\mathcal{P_1}^*$ was shorter than $\mathcal{P_2}^*$ and since in the ALTER step the $\mathcal{P}_{ID}$ must be shorter than $(v_i,v_{i+1},v_{i+2})$ (not equal in length) then this cannot happen.
