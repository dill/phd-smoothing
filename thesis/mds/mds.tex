...
\caption{The grids used to calculate $\mathsf{K}(x,y)$ for the double peninsulae domain. The red grid in the left figure is mapped to the red grid in the right. The number of red points in each of the squares made from the black points in the right plot are used to calculate the spatial density in that square.}
\label{densgrid}
