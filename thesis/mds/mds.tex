...
It therefore seems that taking a 3-dimensional projection would solve these problems without the need for penalty adjustments. However, this is not the case. Looking at the example shape in \fig{mds-comb}, a long domain with peninsulae at each end can be seen.
