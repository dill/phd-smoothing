...
Note that the power is now $\frac{3}{2}$. This is since we do not know the contraction/expansion in each direction individually, but rather the overall change in area. As such we use the $\frac{3}{2}$ power rather than the cubic on $x$ and $y$ and unitary on the cross term.
