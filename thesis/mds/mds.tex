...
There are several methods available to calculate within-area distances

A* -- grid based need critique

graph-based -- don't necessarily respect the boundary, computationally expensive




This section describes a novel algorithm to find the within-area distances.
